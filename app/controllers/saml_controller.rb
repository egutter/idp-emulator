...
class SamlController < ApplicationController
  ...
  PRESET_LOGINS = {
    ...
    "CBCFFMr - One member with APTC subsidy" => {
      "client" => "cbcffmr",
      "account_credential_employer_id" => "a",
      "account_credential_employee_id" => "b",
      "account_credential_ffm_lastname" => "Wolfe",
      "account_credential_ffm_consumerid" => "TEST",
      "account_credential_ffm_partner_consumerid" => "001",
      "account_credential_ffm_firstname" => "Steve",
      "account_credential_ffm_partner_token" => "101",
      "account_credential_ffm_usertype" => "Consumer",
    },
    "CBCFFMr - One member with APTC and CSR subsidy" => {
      "client" => "cbcffmr",
      "account_credential_employer_id" => "a",
      "account_credential_employee_id" => "b",
      "account_credential_ffm_lastname" => "Wolfe",
      "account_credential_ffm_consumerid" => "TEST",
      "account_credential_ffm_partner_consumerid" => "002",
      "account_credential_ffm_firstname" => "Steve",
      "account_credential_ffm_partner_token" => "101",
      "account_credential_ffm_usertype" => "Consumer",
    },
    "CBCFFMr - Two members with APTC subsidy" => {
      "client" => "cbcffmr",
      "account_credential_employer_id" => "a",
      "account_credential_employee_id" => "b",
      "account_credential_ffm_lastname" => "Wolfe",
      "account_credential_ffm_consumerid" => "TEST",
      "account_credential_ffm_partner_consumerid" => "003",
      "account_credential_ffm_firstname" => "Steve",
      "account_credential_ffm_partner_token" => "101",
      "account_credential_ffm_usertype" => "Consumer",
    },
    "CBCFFMr - Two members, one with CSR, and no APTC" => {
      "client" => "cbcffmr",
      "account_credential_employer_id" => "a",
      "account_credential_employee_id" => "b",
      "account_credential_ffm_lastname" => "Wolfe",
      "account_credential_ffm_consumerid" => "TEST",
      "account_credential_ffm_partner_consumerid" => "004",
      "account_credential_ffm_firstname" => "Steve",
      "account_credential_ffm_partner_token" => "101",
      "account_credential_ffm_usertype" => "Consumer",
    },
    "CBCFFMr - Multiple tax household" => {
      "client" => "cbcffmr",
      "account_credential_employer_id" => "a",
      "account_credential_employee_id" => "b",
      "account_credential_ffm_lastname" => "Wolfe",
      "account_credential_ffm_consumerid" => "TEST",
      "account_credential_ffm_partner_consumerid" => "005",
      "account_credential_ffm_firstname" => "Steve",
      "account_credential_ffm_partner_token" => "101",
      "account_credential_ffm_usertype" => "Consumer",
    },
